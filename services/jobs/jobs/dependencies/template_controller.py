...
class TemplateControllerWrapper:
    ...
    def deploy(self, api_connector, template_id, obj_image_stream, cpu_request, cpu_limit, mem_request, mem_limit):
        log = ""

        obj_job = Job(template_id, obj_image_stream, cpu_request, cpu_limit, mem_request, mem_limit)
