    ...
    def __init__(self):
        self.bands = {
            ...
            "s2a_prd_msil1c": [
                ...
                Band("2", 496.6, 10, 0.0001, 0, "int16", "1", name="blue"),
                Band("3", 560, 10, 0.0001, 0, "int16", "1", name="green"),
                Band("4", 664.5, 10, 0.0001, 0, "int16", "1", name="red"),
                Band("5", 703.9, 20, 0.0001, 0, "int16", "1"),
                Band("6", 740.2, 20, 0.0001, 0, "int16", "1"),
                Band("7", 782.5, 20, 0.0001, 0, "int16", "1"),
                Band("8", 835.1, 10, 0.0001, 0, "int16", "1", name="nir"),
